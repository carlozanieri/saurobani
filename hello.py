...
class HelloWorld():
    ...
    def index(self, **kwargs):
        ...
        ###elif cherrypy.url() == 'carlozanieri.net/phpmyadmin':
        ###    tmpl = env.get_template('phpadmin.html')
            
       ###elif cherrypy.url() == 'carlozanieri.net:9000':
       ###     tmpl = env.get_template('webmin.html')
    ...
    @cherrypy.expose
    def slide2(self, luogo):
       
        tmp=env.get_template('nivo2.html')
        streamValue=tmp.generate()
    ...
    def slidec(self, luogo):
        ...
        return tmp.render( slider=Connect.sliderc("", "static/img/mostrairanc/"), i=0, renderer="json")


    @cherrypy.expose
    def didascalia(self, luogo):
       
        tmp=env.get_template('didascalia.html')
        streamValue=tmp.generate()
